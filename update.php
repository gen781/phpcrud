...
<div class="row">
<div class="col-md-12">
<h3>Ubah Data | PHP CRUD dengan MYSQL</h3>
<hr />
</div>
</div>
...
<div class="col-md-4"><b>No. HP</b>
<input type="text" name="contactno" value="<?php echo htmlentities($row['ContactNumber']);?>" class="form-control" maxlength="13" required>
</div>
</div>  
